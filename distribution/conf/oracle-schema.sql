...
CREATE TABLE config_info_aggr (
                                  ...
                                  tenant_id varchar2(128 char) DEFAULT '',
                                  PRIMARY KEY (id),
                                  CONSTRAINT uk_cfginfoaggr_dtgrp UNIQUE  (data_id,group_id,tenant_id,datum_id)
)  ;
...
CREATE TABLE config_info_beta (
                                  ...
                                  PRIMARY KEY (id),
                                  CONSTRAINT uk_cfgbeta_dgt UNIQUE (data_id,group_id,tenant_id)
)  ;
...
CREATE TABLE config_info_tag (
                                 ...
                                 src_ip varchar2(50 char) DEFAULT NULL,
                                 PRIMARY KEY (id),
                                 CONSTRAINT uk_configinfotag_dgtenanttag UNIQUE  (data_id,group_id,tenant_id,tag_id)
)  ;
...
CREATE TABLE config_tags_relation (
                                      ...
                                      PRIMARY KEY (nid),
                                      CONSTRAINT uk_conftagrelation_confidtag UNIQUE  (id,tag_name,tag_type)
)  ;
...
CREATE INDEX idx_conf_tags_rel_tenantid ON config_tags_relation (tenant_id);
...
CREATE TABLE group_capacity (
                                id number(19) check (id > 0) NOT NULL,
                                group_id varchar2(128 char) DEFAULT '' NOT NULL,
                                quota number(10) DEFAULT '0' check (quota > 0) NOT NULL,
                                usage number(10) DEFAULT '0' check (usage > 0) NOT NULL,
                                max_size number(10) DEFAULT '0' check (max_size > 0) NOT NULL,
                                max_aggr_count number(10) DEFAULT '0' check (max_aggr_count > 0) NOT NULL,
                                max_aggr_size number(10) DEFAULT '0' check (max_aggr_size > 0) NOT NULL,
                                max_history_count number(10) DEFAULT '0' check (max_history_count > 0) NOT NULL,
                                gmt_create timestamp(0) DEFAULT SYSTIMESTAMP NOT NULL,
                                gmt_modified timestamp(0) DEFAULT SYSTIMESTAMP NOT NULL,
                                PRIMARY KEY (id),
...
CREATE TABLE his_config_info (
                                 id number(19) check (id >= 0) NOT NULL,
                                 nid number(19) check (nid > 0) NOT NULL,
                                 data_id varchar2(255 char) NOT NULL,
                                 group_id varchar2(128 char) NOT NULL,
                                 app_name varchar2(128 char) DEFAULT NULL,
                                 content clob NOT NULL,
...
COMMENT ON COLUMN permissions.RESOURCES IS 'resource';
