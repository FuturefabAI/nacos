...
public class ConfigTagsRelationMapperByOracle extends AbstractMapper implements ConfigTagsRelationMapper {
    ...
    public MapperResult findConfigInfo4PageFetchRows(MapperContext context) {
        ...
        final String sql = "SELECT * FROM ("
                + "SELECT a.id,a.data_id,a.group_id,a.tenant_id,a.app_name,a.content, ROWNUM rnum FROM config_info a LEFT JOIN "
    ...
    public MapperResult findConfigInfoLike4PageFetchRows(MapperContext context) {
        ...
        if (StringUtils.isBlank(tenant)) {
            where = new StringBuilder(" WHERE a.tenant_id is NULL ");
        } else {
            where = new StringBuilder(" WHERE a.tenant_id LIKE ? ");
            paramList.add(tenant);
        }
